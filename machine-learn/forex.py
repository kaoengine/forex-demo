...
class FXModule(pl.LightningModule):
    def __init__(self, source_size, target_size, hidden_size, num_layers, 
                 bidirectional, dropout, lr):
        """ Args:
                source_size (int): The expected number of features in the input.
                target_size (int): The expected number of sequence features.
                hidden_size (int): The number of features in the hidden state.
        ...
        self.en_fc = nn.Linear(num_layers*num_directions, num_layers)
        ...
        self.de_fc = nn.Linear(hidden_size, target_size)
    ...
    def training_step(self, batch, batch_idx):
        ...
        output, _ = self(hidden, self.target_size, y, True)

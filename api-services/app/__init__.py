...
def forex():
    ...
    data = [
        {
            "DATE_TIME": ["2000.01.03 00:00:00","2000.01.03 00:15:00","2000.01.03 00:30:00"],
            "HIGH": [1.008,1.0087,1.0089],
            "LOW": [1.0073,1.0076,1.0079],
            "OPEN": [1.0073,1.0078,1.0087],
            "CLOSE": [1.0077, 1.0086, 1.0079]
        },
    ]
